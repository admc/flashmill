...
var controller = {};  Components.utils.import('resource://flashunit/modules/controller.js', controller);
var httpd = {};   Components.utils.import('resource://flashunit/stdlib/httpd.js', httpd);
var os = {};      Components.utils.import('resource://flashunit/stdlib/os.js', os);
var strings = {}; Components.utils.import('resource://flashunit/stdlib/strings.js', strings);
var arrays = {};  Components.utils.import('resource://flashunit/stdlib/arrays.js', arrays);
var withs = {};   Components.utils.import('resource://flashunit/stdlib/withs.js', withs);
...
var loadTestResources = function () {
  if (mozmill == undefined) {
    mozmill = {};
    Components.utils.import("resource://flashunit/modules/mozmill.js", mozmill);
  }
  if (elementslib == undefined) {
    elementslib = {};
    Components.utils.import("resource://flashunit/modules/elementslib.js", elementslib);
  }
}
...
function Collector () {
  ...
  // var logging = {}; Components.utils.import('resource://flashunit/stdlib/logging.js', logging);
...
function Runner (collector) {
  ...
  var m = {}; Components.utils.import('resource://flashunit/modules/mozmill.js', m);
...
Runner.prototype.end = function () {
  ...
  controller.sleep(5000);
  events.fireEvent('pass', {message:'endRunner event fired.'});
}
...
var runTestDirectory = function (dir) {
  ...
  events.fireEvent('pass', {message:'Running test directory.'});
  runner.runTestDirectory(dir);
  events.fireEvent('pass', {message:'Finished running test directory.'});
  runner.end();
  events.fireEvent('pass', {message:'runner.end() called '});
  return true;
}
