...
var flashunit = {
  ...
  go: function() {
    var mt = getWindowByTitle('flashunit Runner');
    if (mt){
      mt.focus();
    }
    else {
      var w = window.open("chrome://flashunit/content/flashunit.html", "", "chrome,centerscreen,height=300,width=300,resizable"); 
    }
  }
};

window.addEventListener("load", function(e) { flashunit.onLoad(e); }, false);
...
var Overlay = {
  init: function(){
    ...
    var current = gExtensionManager.getItemForID("flashunit@adamchristian.com").version;
	...
	firstrun = Prefs.getBoolPref("firstrun");
      ...
      if (firstrun){
        ...
        window.setTimeout(function(){
          gBrowser.selectedTab = gBrowser.addTab("about:flashunit");
