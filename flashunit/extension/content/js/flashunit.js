...
var flashunit = new function(){
  ...
  this.recursiveSearch = function(frame){
    ...
    var tags = frame.document.getElementsByTagName("embed");
    for (var i=0;i<tags.length;i++){
      ...
      for (var i = 0; i < iframeCount; i++){
          try {
            var tags = iframeArray[i].document.getElementsByTagName("embed");
