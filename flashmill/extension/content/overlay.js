...
var flashmill = {
  ...
  go: function() {
    ...
    if (mt){
      ...
      var w = window.open("chrome://flashmill/content/flashmill.html", "", "chrome,centerscreen,height=300,width=300,resizable"); 
    }
  }
};

window.addEventListener("load", function(e) { flashmill.onLoad(e); }, false);
...
var Overlay = {
  init: function(){
    ...
    var current = gExtensionManager.getItemForID("flashmill@adamchristian.com").version;
	...
	firstrun = Prefs.getBoolPref("firstrun");
      ...
      if (firstrun){
        ...
        window.setTimeout(function(){
          gBrowser.selectedTab = gBrowser.addTab("about:flashmill");
